# Contributing to Hockey Event Ranking
...
| `public/data/`    | Competition roster JSON       |
...
To validate and update roster data:

```bash
npm run update-data
npx tsx scripts/update-data.ts --fill-national   # Add national position
npx tsx scripts/update-data.ts --fill-summary    # Add team metrics
```
